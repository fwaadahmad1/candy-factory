...
>(({className, children, ...props}, ref) => (
    <NavigationMenuPrimitive.Root
        ref={ref}
        className={cn(
            "fixed bg-card h-screen z-10 flex max-w-max flex-1 flex-col items-center justify-start p-8",
            className
        )}
        {...props}
    >
...
>(({className, ...props}, ref) => (
    <NavigationMenuPrimitive.List
        ref={ref}
        className={cn(
            "group flex flex-1 flex-col list-none items-center justify-center space-y-4",
            className
        )}
        {...props}
    />
...
>(({className, ...props}, ref) => (
    <div className={cn("absolute left-full top-24")}>
